<?php 
	...
	if (isset($_POST['create'])) {
		...
		if (strlen($name)>60 || strlen($user)>60 || strlen($password)>60 || strlen($dui)>13 || strlen($tel1)>10 || strlen($tel2)>10 || strlen($address)>60 || strlen($depto)>60 || strlen($city)>60) {	
			...
			echo "<script>alert('¡Registro Almacenado Éxitosamente!'); window.location=('../index.php');</script>";
		}
	}
?>

<div class="container"><br><br>
	<h3 class="text-primary"><p>¡Completa El Siguiente Formulario Para Unirte A Nuestra Comunidad!</p></h3>
	<hr>
